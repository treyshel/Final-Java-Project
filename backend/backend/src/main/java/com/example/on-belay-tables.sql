...
INSERT INTO student_achievements(id, student_id, programming_langs, bio, academics, interests) VALUES (1, 1, 'python', 'Software Developer', 'Pontotoc High', 'fishing');
INSERT INTO student_achievements(id, student_id, programming_langs, bio, academics, interests) VALUES (2, 2, 'java', 'Software Engineer', 'LHS', 'cooking');