...
public class StudentDescRepository {
    ...
    public static StudentDesc insertStudentDesc(String programming_langs, String academics, String desired_location) {
        try {
            ...
            PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO student(programming_langs, academics, desired_location)" +
                    "VALUES (?, ?, ?) RETURNING *;");
            ...
            resultSet.next();
            return new StudentDesc(programming_langs, academics, desired_location);
